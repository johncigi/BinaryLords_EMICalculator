...

{
	...
	public void checkLoanAmtSlider(String str1, String str2,String name) throws InterruptedException
	{
		...
		System.out.println(name+" slider for loanamount is working and the value is being reflecting in the textbox: "+x);
	}
	...
	{
		String x=ch.checkSlider( str1, str2);
		System.out.println(name+" slider for loaninterest is working and the value is being reflecting in the textbox: "+x);
    }
	...
	{
		String x=ch.checkSlider(str1, str2);
		System.out.println(name+" slider for loantenure is working and the value is being reflecting in the textbox: "+x);
	}
	...
	{
	    String x=ch.checkSlider(str1, str2);
		System.out.println(name+" slider for loanfees is working and the value is being reflecting in the textbox: "+x);
	}
	...
	{
	    String x=ch.checkSlider(str1, str2);
		System.out.println(name+" slider for loanemi is working and the value is being reflecting in the textbox: "+x);
	}
